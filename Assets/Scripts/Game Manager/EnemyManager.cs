...
public class EnemyManager : MonoBehaviour 
{
    ...
    [SerializeField]
    private GameObject boar_Prefab, cannibal_Prefab; //враги

    public Transform[] cannibal_SpawnPoints, boar_SpawnPoints; //места для спаван

    [SerializeField]
    private int cannibal_Enemy_Count, boar_Enemy_Count;//должное количество врагов 

    private int initial_Cannibal_Count, initial_Boar_Count; //начальное количество врагов

    public float wait_Before_Spawn_Enemies_Time = 10f; //время создания нового врага с момента убийства
    ...
    void SpawnCannibals() //создание канибалов
    {
